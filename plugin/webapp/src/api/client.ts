...
export const api = {
    ...
    resolveCheckpoint: (checkpointID: string, decision: 'approved' | 'rejected', rationale: string): Promise<unknown> => request(`/checkpoints/${encodeURIComponent(checkpointID)}/resolve`, {method: 'POST', body: JSON.stringify({decision, rationale})}),
